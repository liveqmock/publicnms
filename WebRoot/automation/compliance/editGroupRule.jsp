...
<script type="text/javascript" src="<%=rootPath%>/automation/js/ext-all.js" charset="gb2312"></script>
<script type="text/javascript" src="<%=rootPath%>/automation/js/ext-lang-zh_CN.js" charset="utf-8"></script>
